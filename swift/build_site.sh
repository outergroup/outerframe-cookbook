...
rm -rf "${DERIVED_DATA_DIR}" "${BINARY_ROOT}" "${OUTER_PATH}"
mkdir -p "${BINARY_ROOT}"
...
BUILT_BUNDLE="${PRODUCTS_DIR}/OuterframeCookbookSwift.bundle"
...
echo "==> Writing cookbook-macos-swift.outer"
/usr/bin/python3 "${REPO_ROOT}/Scripts/generate_outer.py" \
